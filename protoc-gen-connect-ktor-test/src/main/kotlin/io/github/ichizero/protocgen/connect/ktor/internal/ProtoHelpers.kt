 ...
 */
private fun stripProto(filename: String): String = if (filename.endsWith(".protodevel")) {
 ...
 */
internal fun getFileJavaPackage(file: FileDescriptor): String = if (file.options.hasJavaPackage()) {
 ...
 * message descriptor.
 */
internal fun getClassName(descriptor: Descriptors.Descriptor): String = toJavaName(descriptor.fullName, descriptor.file)

/**
 * Returns the fully-qualified class name corresponding to the given
 * enum descriptor.
 */
internal fun getClassName(
    descriptor: Descriptors.EnumDescriptor,
): String = toJavaName(descriptor.fullName, descriptor.file)
 ...
 * number constant.
 */
internal fun getFieldConstantName(field: Descriptors.FieldDescriptor): String = field.name.uppercase() + "_FIELD_NUMBER"
