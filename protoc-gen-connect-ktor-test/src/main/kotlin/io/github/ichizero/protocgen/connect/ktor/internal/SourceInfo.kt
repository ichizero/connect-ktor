...
internal class SourceInfo(
    ...
    fun push(value: Int): SourceInfo = SourceInfo(helper, descriptorSource, path.plus(value))

    fun comment(): String = helper.getComment(path)
}
...
internal class SourceCodeHelper(
    ...
    private val locations: Map<List<Int>, List<DescriptorProtos.SourceCodeInfo.Location>> =
        makeLocationMap(fileDescriptorProto.sourceCodeInfo.locationList)
