        ...
        <div className="relative flex flex-col gap-20 pb-16 pt-6 md:gap-28 md:pb-24 md:pt-10">
            ...
            <section className="relative flex flex-col items-center text-center">
                ...
                <p className="mt-6 max-w-2xl text-base text-fd-muted-foreground sm:text-lg">
                    Connect-Ktor brings the Connect Protocol to existing Ktor apps without asking them to abandon REST.
                    Same process, typed RPCs, gradual adoption.
                </p>
                ...
                <div className="mt-8 flex max-w-2xl items-start gap-3 rounded-2xl border border-brand-blue/15 bg-brand-blue/[0.04] px-4 py-3 text-left text-sm text-fd-muted-foreground">
                    ...
                    <p>
                        <span className="font-medium text-fd-foreground">Unofficial library.</span> Connect-Ktor is a
                        community project, not published by the ConnectRPC organization. It extends Connect-Kotlin for
                        Ktor and tracks the Connect conformance suite independently. For Connect itself, Connect-Kotlin
                        clients, or the protocol, see the official{" "}
                        <a
            ...
            <section className="relative">
                <div className="mb-8 max-w-2xl">
                    ...
                    <p className="mt-3 text-fd-muted-foreground">
                        Keep the server you have. Layer Connect where it pays off, and leave the rest of the REST
                        surface alone.
                    </p>
                </div>
            ...
            <section className="relative">
                <div className="mb-8 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                    <div className="max-w-2xl">
                        ...
                        <h2 className="text-3xl font-semibold tracking-tight lg:text-4xl">Start where you need.</h2>
                    </div>
                    <Link
            ...
            <section className="relative overflow-hidden rounded-3xl border border-brand-blue/20 bg-gradient-to-br from-brand-blue to-brand-cyan px-6 py-10 text-white md:px-10 md:py-12">
                ...
                <div className="relative max-w-2xl">
                    <h2 className="text-3xl font-semibold tracking-tight">Ship Connect on the Ktor you already run.</h2>
                    <p className="mt-3 text-white/85">
                        Wire a handler, keep your REST routes, and grow the Connect surface one RPC at a time.
                    </p>
